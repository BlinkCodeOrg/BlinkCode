    ...
    <div className="landing">
      <nav className="landing-nav">
        <div className="landing-nav-left">
          ...
          <a href="https://github.com/BlinkCodeOrg/BlinkCode" target="_blank" rel="noopener noreferrer" className="landing-nav-link">GitHub</a>
      ...
      <footer className="landing-footer">
        ...
        <div className="landing-footer-links">
          <a href="https://github.com/BlinkCodeOrg/BlinkCode" target="_blank" rel="noopener noreferrer">GitHub</a>
        </div>
