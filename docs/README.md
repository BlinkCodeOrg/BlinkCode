<p align="center">
  <img src="../src/assets/BlinkCode-logo.svg" alt="BlinkCode logo" width="96" />
</p>

# BlinkCode Documentation

<p align="center">
  <a href="../README.md">← Project README (EN)</a>
  &nbsp;·&nbsp;
  <a href="../README.ru.md">← README проекта (RU)</a>
</p>

This folder contains the full BlinkCode documentation in English and Russian.
Эта папка содержит полную документацию BlinkCode на английском и русском.
...
| Development / Разработка | [development.md](./EN/development.md) | [development.md](./RU/development.md) |
| Building & packaging / Сборка и упаковка | [building.md](./EN/building.md) | [building.md](./RU/building.md) |
...
- 📦 Producing installer / portable builds → [EN/building.md](./EN/building.md)
...
- 📦 Сборка installer / portable → [RU/building.md](./RU/building.md)
- 🏠 Назад к [README проекта](../README.ru.md)
